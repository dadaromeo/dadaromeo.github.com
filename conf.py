...
<div class="sidebar-module">
    <h4>Social Media</h4>
    <ul class="list-group">
        <li class="list-group-item"><strong>Twitter:</strong> <a href="https://twitter.com/dadaromeo">@dadaromeo</a></li>
        <li class="list-group-item"><strong>GitHub:</strong> <a href="https://github.com/dadaromeo">dadaromeo</a></li>
    </ul>
</div>
"""}
